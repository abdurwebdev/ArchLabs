...
export default function Home() {
  ...
  <div className="grid grid-cols-1 h-auto px-3  md:px-0">
    <div className=" h-[850px] xl:h-[900px] sm:h-[800px] md:h-[700px] ">
      <UniqueOne/>
    </div>
    <div className=" h-[850px] xl:h-[900px] md:h-[700px] sm:h-[800px]">
      <UniqueTwo/>
    </div>
    <div className=" h-[900px] xl:h-[900px] md:h-[700px] sm:h-[800px]">
    <UniqueThree/>
    </div>
    <div className=" h-[1000px] xl:h-[900px] md:h-[700px] sm:h-[1000px]">
      <UniqueFour/>
    </div>
    <div className=" h-[1300px] xl:h-[1000px] md:h-[700px] sm:h-[1200px] ">
      <UniqueFive/>
    </div>
  </div>
  <div className="bg-[#F8F9FA] w-full h-[900px] flex flex-col items-center ">
    <div className="mt-20" ref={testRef}>
    <h1 className="font-bold text-5xl text-center text-[#96BB7C]">Testimonials</h1>
    <h1 className="font-bold text-5xl text-center mb-10">Happy Clients</h1>
    </div>
